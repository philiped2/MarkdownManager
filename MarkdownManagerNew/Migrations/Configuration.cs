        ...
        protected override void Seed(MarkdownManagerNew.Models.ApplicationDbContext context)
        {
            ...
            try
            {
                ...
                if (context.DeleteArchivedDocumentTimeSetting.Count() == 0)
                {
                    ...
                    context.DeleteArchivedDocumentTimeSetting.Add(deleteArchivedDocumentTimeSetting); //Lägger till instans för inställningen i databasen. Avaktiverad som standard
                }
